...
export function PaymentQRDialog({ open, onOpenChange, qrCodeData, amount, onBack, orderDetail }: PaymentQRDialogProps) {
    // Format currency
    ...
    const handlePrint = () => {
        ...
        if (printContent && windowPrint && orderDetail) {
      ...
      `)
            ...
            // Fallback for when orderDetail is not available
            const basicPrintContent =
                printContent && windowPrint
                    ? `
        <html>
          <head>
      ...
      `
            ...
            if (windowPrint && basicPrintContent) {
                windowPrint.document.write(basicPrintContent)
                windowPrint.document.close()
                windowPrint.focus()
                windowPrint.print()
                windowPrint.close()
