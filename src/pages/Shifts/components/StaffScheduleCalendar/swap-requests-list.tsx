              ...
              <div className='grid grid-cols-1 md:grid-cols-2 gap-4 mt-2'>
                <div className='space-y-2 p-3 bg-white rounded-md border border-green-100'>
                  <div className='flex items-center gap-2'>
                    <Avatar className='h-8 w-8 bg-green-100 text-green-700 border border-green-200 shrink-0'>
                      <AvatarFallback>{getInitials(request.employeeFromName)}</AvatarFallback>
                    </Avatar>
                    <div className='font-medium text-green-800 truncate'>{request.employeeFromName}</div>
                  </div>
                ...
                <div className='space-y-2 p-3 bg-white rounded-md border border-green-100'>
                  <div className='flex items-center gap-2'>
                    ...
                    <div className='font-medium text-green-800 truncate'>{request.employeeToName}</div>
                  </div>
                  <div className='text-sm space-y-1 ml-10'>
                    <div className='flex items-center gap-2 text-gray-700'>
                      <CalendarDays className='h-3.5 w-3.5 text-green-600 shrink-0' />
